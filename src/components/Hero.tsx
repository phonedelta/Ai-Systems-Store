...
export function Hero() {
  return (
    <section id="home" className="mesh-light relative overflow-hidden pt-24 pb-12 md:pt-32 md:pb-16">
      ...
      <div className="container relative grid items-center gap-10 sm:gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
        ...
        <motion.div
          ...
          className="relative mx-auto w-full max-w-lg pb-6 sm:max-w-xl sm:pb-10 lg:max-w-none lg:pb-12"
        >
          <ImageFrame
            src={asset('images/hero-illustration.png')}
            alt="AI Systems Store workspace illustration"
            imgClassName="media-shine aspect-[3/2] sm:aspect-[16/11]"
          />

          <div className="relative z-20 mx-auto mt-5 w-[78%] max-w-xs sm:absolute sm:-bottom-2 sm:-left-2 sm:mt-0 sm:w-[48%] sm:max-w-none md:-bottom-4 md:-left-4 lg:-left-6">
            <div className="pointer-events-none absolute -inset-2 rounded-2xl bg-brand-500/20 blur-xl" />
            <img
              src={asset('images/dashboard-mockup.png')}
              alt="AI Systems hub integrations preview"
              className="relative w-full rounded-xl border border-white/80 bg-[#0b1224] shadow-2xl ring-1 ring-brand-400/30 sm:rounded-2xl"
              loading="lazy"
            />
          </div>
        </motion.div>
